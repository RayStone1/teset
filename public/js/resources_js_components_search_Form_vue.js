        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this2.getFilteredMunOne();
              case 2:
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this3.getFilteredMunTwo();
              case 2:
                _context3.next = 4;
                return _this3.getFilteredName();
              case 4:
                if (!(Object.keys(_this3.filteredMunTwo) == 0)) {
                  _context3.next = 7;
                  break;
                }
                _this3.findName();
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _this5.isLoadingTable(true);
                _this5.ActiveType(null);
                _context5.next = 4;
                return _this5.getFilteredSource();
              case 4:
                _this5.isLoadingTable(false);
  ...
  return _c(
    ...
    [
      _c("h4", { staticClass: "mb-7" }, [
        _vm._v("Выберите необходимый уровень"),
      ]),
      _vm._v(" "),
      _c("v-autocomplete", {
